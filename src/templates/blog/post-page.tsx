...
export function PostPage({ post }: PostPageProps) {
  ...
  return (
    <main className="my-28 text-gray-100">
      <div className="container space-y-12 px-4 md:px-8">
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem>
              <BreadcrumbLink className="text-action-sm" asChild>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-6 lg:gap-12">
          <article className="bg-gray-600 rounded-lg overflow-hidden border-gray-400 border-[1px]">
            ...
            <header className="px-4 md:px-6 lg:px-12 mt-8 md:mt-12">
              ...
              <Avatar.Conatiner>
                ...
                <Avatar.Content>
                  ...
                  <Avatar.Description>Publicao em {" "} <time dateTime={post?.date}>{publisheDate}</time></Avatar.Description>
                </Avatar.Content>
              </Avatar.Conatiner>
            </header>
