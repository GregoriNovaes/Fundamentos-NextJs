...
export function FeatureSection() {
  return (
    <section className="container bg-gray-700 grid gap-6 md:grid-cols-2 py-[6rem]">
      ...
      <div className="col-span-full flex flex-col gap-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounded-lg bg-gray-500 p-6 md:p-12">
          <div className="flex flex-col gap-4">
            ...
            <Button className="hidden w-fit rounded-full mt-4 md:mt-auto md:flex" asChild>
          ...
          <div className="flex flex-col items-center justify-center w-full">
            <div className="w-full max-w-md overflow-hidden">
              <Image src="/Feature-Section.svg" alt="Features" className="object-cover w-full" width={440} height={330} />
            </div>
